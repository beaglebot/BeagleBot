...
{
    public abstract class SingleAddressI2CSlaveComponent : I2CSlaveComponent
    {
        #region Constructors

        protected SingleAddressI2CSlaveComponent() : base()
        {
        }
        ...
        {
            if (I2CBus == null || I2CBus.State != BusState.Connected) return false;
